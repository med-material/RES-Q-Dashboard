rowmaker_Num_UI <- function(id) {
  ns <- NS(id)
  fixedRow(
    column(2, h6(textOutput(ns("QIName")), align = "center")),
    column(1, h6(textOutput(ns("QIM1")), align = "center")),
    column(1, h6(textOutput(ns("QIM2")), align = "center")),
    column(4, plotlyOutput(ns("vis1"), width = "200px", height = "50px"), align = "center"),
    column(3, plotlyOutput(ns("vis2"), width = "200px", height = "50px"), align = "center"),
