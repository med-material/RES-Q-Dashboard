visualization_Layout <- function(id, database) {
  ...
  column(
    ...
    tabsetPanel(type = "tabs",
                tabPanel("Plot", plot_Visualization_UI(id, database)),
                tabPanel("Table", plot_Visualization_Table(id))
    )
  )
}

plot_Visualization_UI <- function(id, database) {
  ns <- NS(id)
...
plot_Visualization_Table <- function(id) {
  ns <- NS(id)
  dataTableOutput(
    outputId = ns("table")
  )
...
plot_Visualization <- function(id, database) {
  moduleServer(
    id,
