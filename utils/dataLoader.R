dataLoader <- function() {
  ...
  numVars_cols <- c(
    "site_country", "site_name", "discharge_year", "discharge_quarter", "age", "nihss_score", "door_to_needle", "door_to_groin",
  ...
  catVars_cols <- c(
    "site_country", "site_name", "discharge_year", "discharge_quarter", "gender", "hospital_stroke", "hospitalized_in",
